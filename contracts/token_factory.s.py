...
# Source of truth: templates/token_factory_xsc001_token_template.s.py. Regenerate via `uv run --project ../xian-cli python ./scripts/generate_token_factory_artifacts.py --write`.
XSC001_TOKEN_SOURCE = (
